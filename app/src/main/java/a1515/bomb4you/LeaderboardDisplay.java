...
public class LeaderboardDisplay extends AppCompatActivity{
    ...
    private final String leaderboardsURL="http://bomb4you.tk/api/v1/score/leaderboard_background";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.activity_leaderboad_display);
...
//        getUserInfoFromWeb();
//        final SharedPreferences sharedPref = getSharedPreferences("Preferences", Context.MODE_PRIVATE);
//        if(!sharedPref.getString("user-token","").equals("")){
//            getLeaderboards(3);
//        }
